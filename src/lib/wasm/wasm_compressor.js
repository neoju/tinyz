/* @ts-self-types="./wasm_compressor.d.ts" */
...
export class CompressionResult {
    ...
    get bytes() {
        try {
            ...
            wasm.compressionresult_bytes(retptr, this.__wbg_ptr);
     ...
     */
    get compression_ms() {
        const ret = wasm.compressionresult_compression_ms(this.__wbg_ptr);
        return ret;
    }
}
 ...
 * @returns {Uint8Array}
 */
export function compress_image(input_bytes, quality, format) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        wasm.compress_image(retptr, ptr0, len0, quality, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
 ...
 */
export function compress_image_with_metadata(input_bytes, quality, format) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(input_bytes, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(format, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        wasm.compress_image_with_metadata(retptr, ptr0, len0, quality, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
        ...
        return CompressionResult.__wrap(r0);
    } finally {
        wasm.__wbindgen_add_to_stack_pointer(16);
    }
}
 ...
 * @returns {Uint8Array}
 */
export function compress_png(input_bytes, quality) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(input_bytes, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        wasm.compress_png(retptr, ptr0, len0, quality);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('wasm_compressor_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
